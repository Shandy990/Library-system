        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-3">
                <div class="input-group mb-3 collection__search-group">
                    ...
                    <form method="GET">
                    <input type="text" class="form-control book-collection__search-input" placeholder="Search Book Title" name="search"
                        id="collection_search" value="{{request()->search}}">
                    </form>
                </div>
            </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="book-collection__book-container">
                        ...
                        <div class="book-collection__btn-container">
                            <a href="{{ route('book.show', $book->id) }}" class="btn book-collection__btn">Book
                                Detail</a>
                        </div>
                    </div>
                </div>
