...
@section('content')
    <div class="book-collection container">
        <h1 class="book-collection__title text-center">Deleted Book Collection</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="input-group mb-3 collection__search-group">
                    ...
                    <input type="text" class="form-control book-collection__search-input" placeholder="Search Book Title" name="collection_search"
                    ...
                    <div class="book-collection__book-container">
                        ...
                        <div class="book-collection__btn-container">
                            <form action="{{ route('book.destroy', $book->id) }}" method="POST"
                                id="destroy-{{ $book->id }}">
                                @csrf
                                <a onclick="document.getElementById('destroy-{{ $book->id }}').submit()" class="btn book-collection__btn">Delete
                                    Book Permanently</a>
                            </form>
                        </div>
                    </div>
